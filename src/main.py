...
try:
    ...
    print("Note: Financial data modules require additional dependencies (yfinance, scipy, etc.)")
...
def run_full_analysis(start_date: str = "2020-10-01"):
    ...
    if FINANCIAL_MODULE_AVAILABLE:
        ...
        print("\n[Step 3/5] Financial data collection skipped (module not available)")
        print("-"*80)
        print("To enable financial data analysis, install all dependencies:")
